        ...
        <section className="mb-20">
          ...
          <div className="space-y-6 text-lg leading-relaxed text-foreground/80">
            ...
            <div>
              ...
              <p>
                После согласования времени публикации обязательно разместите наш пост вовремя. Если в течение <span className="font-semibold">15</span> минут после договоренного времени пост не будет опубликован, мы оставляем за собой право удалить ваш пост у нас.
              </p>
            </div>
